      ...
      <div className="flex items-center gap-2">
        ...
        {onTriggerScan && (
          <button
            ...
            disabled={isScanning}
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-md font-display text-[11px] font-bold transition-all duration-200"
            style={{
              background: isScanning ? 'var(--glass-surface)' : 'rgba(0, 229, 255, 0.1)',
              color: isScanning ? 'var(--text-muted)' : '#00e5ff',
              border: isScanning ? '1px solid var(--glass-border)' : '1px solid rgba(0, 229, 255, 0.3)',
        ...
        {onSubscribe && (
          <button
            onClick={onSubscribe}
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-md font-display text-[11px] font-bold transition-all duration-200 cursor-pointer"
            style={{
